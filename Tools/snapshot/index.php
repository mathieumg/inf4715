...
$GLOBALS['CONFIG']['HIDE_FILES'] = array('./config.php', './index.php', './upload.php', './error_log');
$GLOBALS['CONFIG']['DENY_SOURCE'] = array('config.php');
$GLOBALS['CONFIG']['WEB_FILES'] = array('php','php4','php3','phtml','html','htm','js','asp','xml','css','bml','cgi','cfm','apm','jhtml','xhtml','aspx','tpl','inc','c','h','vb','py','sh','pl','cpp', 'glsl', 'txt');
...
// Permet d'afficher les erreurs d'exécution
