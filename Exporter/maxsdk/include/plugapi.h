...
#define MAX_RELEASE					MAX_RELEASE_R15
...
#define MAX_API_NUM					MAX_API_NUM_R150
...
#define FRONTEND_CONTROL_CLASS_ID	0x001040    //!< \deprecated Front-end-controller functionality has been superceeded by class CUIFrameMgr.
#pragma deprecated("FRONTEND_CONTROL_CLASS_ID")
...
#pragma warning( disable : 4481 )
		...
		virtual FPInterface* GetInterface(MCHAR* name) sealed { return GetInterface(const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
