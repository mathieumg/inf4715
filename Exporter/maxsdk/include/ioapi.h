...
struct Color64;
struct range;
namespace MaxSDK { namespace AssetManagement { struct AssetId; enum AssetType;} }
enum ParamType2;
class FloatChange;
class VertOffset;
struct ParticleID;
...
public:
	...
	IOResult WriteVoid(const void *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult WriteEnum(const void *buf, ULONG nbytes, ULONG *nwrit) {DbgAssert(nbytes == sizeof(int)); return Write((void*)buf, nbytes, nwrit);}

	IOResult Write(const char  *buf, ULONG nbytes, ULONG *nwrit) 
	{
		DbgAssert( buf == NULL || strlen(buf) <= nbytes);
		return Write((void*)buf, nbytes, nwrit);
	}
	IOResult Write(const wchar_t  *buf, ULONG nbytes, ULONG *nwrit)  
	{
		DbgAssert( buf == NULL || wcslen(buf) <= nbytes);
		return Write((void*)buf, nbytes, nwrit);
	}

	IOResult Write(const int  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const unsigned int  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const INT64  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const unsigned __int64  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const float  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const double  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const short  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const unsigned short  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const long  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const unsigned long  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const BYTE  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const bool  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Point2  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Point3  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Point4  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const AColor  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Color  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Matrix2  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Matrix3  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Box2  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Box3  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const MNVert  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const TVPatch  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Face  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Class_ID  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const VertMove  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const FaceCreate  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const FaceRemap  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const FaceChange  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const FaceSmooth  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const UVVertSet  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const TVFace  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Interval  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const AngAxis  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Quat  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Ray  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const ScaleValue  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const RotationValue  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const FBox2  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const HookPoint  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const PolyPt  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const bindShape  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const EPMapVert  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const EPMapPatch  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const EPMapUVVert  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const RandGenerator  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Interface_ID  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const BlockKeysClass  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Color24  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Color48  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const Color64  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const POINT  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const WINDOWPLACEMENT  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const range  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const MaxSDK::AssetManagement::AssetId  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const ParamType2  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const FloatChange  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const VertOffset  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const ParticleID  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const PreciseTimeValue  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const DeviceRect  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
	IOResult Write(const IPoint2  *buf, ULONG nbytes, ULONG *nwrit) {return Write((void*)buf, nbytes, nwrit);}
...
public:
	...
	*/
	virtual DWORD SavingVersion() const { return  0; }
...
public:
	...
	IOResult ReadVoid(const void *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult ReadEnum(const void *buf, ULONG nbytes, ULONG *nwrit) {DbgAssert(nbytes == sizeof(int)); return Read((void*)buf, nbytes, nwrit);}

	IOResult Read(const char  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const wchar_t  *buf, ULONG nbytes, ULONG *nwrit)  {return Read((void*)buf, nbytes, nwrit);}

	IOResult Read(const int  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const unsigned int  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const INT64  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const unsigned __int64  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const float  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const double  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const short  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const unsigned short  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const long  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const unsigned long  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const BYTE  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const bool  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Point2  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Point3  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Point4  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const AColor  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Color  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Matrix2  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Matrix3  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Box2  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Box3  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const MNVert  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const TVPatch  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Face  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Class_ID  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const VertMove  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const FaceCreate  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const FaceRemap  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const FaceChange  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const FaceSmooth  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const UVVertSet  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const TVFace  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Interval  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const AngAxis  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Quat  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Ray  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const ScaleValue  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const RotationValue  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const FBox2  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const HookPoint  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const PolyPt  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const bindShape  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const EPMapVert  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const EPMapPatch  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const EPMapUVVert  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const RandGenerator  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Interface_ID  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const BlockKeysClass  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Color24  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Color48  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const Color64  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const POINT  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const WINDOWPLACEMENT  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const range  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const MaxSDK::AssetManagement::AssetId  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const ParamType2  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const FloatChange  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const VertOffset  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const ParticleID  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const PreciseTimeValue  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const DeviceRect  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
	IOResult Read(const IPoint2  *buf, ULONG nbytes, ULONG *nwrit) {return Read((void*)buf, nbytes, nwrit);}
...
public:
	...
	*/
	...
	// default value for mFile3dsMaxLanguageID, mFileUserLanguageID, mFileSaveAsVersion, mFileActiveCodePage if not loaded from scene file
	...
	virtual WORD File3dsMaxLanguageID() { return kFileSaveAsVersionNotSpecified; }
	//! \brief the user language id when the file was saved - kFileSaveAsVersionNotSpecified if not loaded from file
	virtual LANGID FileUserLanguageID() { return kFileSaveAsVersionNotSpecified; }
	//! \brief the 'Save As' version number when the file was saved - kFileSaveAsVersionNotSpecified if not loaded from file
	virtual DWORD FileSaveAsVersion() { return kFileSaveAsVersionNotSpecified; }
	//! \brief the Active Code Page when the file was saved - kFileSaveAsVersionNotSpecified if not loaded from file
	virtual UINT FileActiveCodePage() { return kFileSaveAsVersionNotSpecified; }
