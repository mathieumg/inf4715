...
#pragma warning( disable : 4481 )
	...
	virtual void SetElementName( MCHAR* newName ) sealed { SetElementName(const_cast<const MCHAR*>(newName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	...
	virtual void SetFileName( MCHAR* newName) sealed { SetFileName(const_cast<const MCHAR*>(newName)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	...
	virtual void SetFileType( MCHAR* newType) sealed { SetFileType(const_cast<const MCHAR*>(newType)); }
#pragma warning( pop )
	...
	\code
	const int FindParamByName1( sealed MCHAR* name )
	{
		for( int i = 0; i < 8; ++i ) {
...
#pragma warning( disable : 4481 )
	...
	virtual	const int FindParamByName( MCHAR* name ) sealed { return FindParamByName(const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
