...
#if defined(BLD_UTIL) || !defined(UNICODE)
...
#pragma region Protected members and methods
	...
	**/
	 ...
	 * \param		Size of the passed buffer
	...
	**/
	 ...
	 *
	 * \param		The buffer to evaluate the number of line
...
public:
	...
	**/
	 ...
	 * \param len				 Size of the buffer to check
	 ...
	 * \param length    Length of data (in MCHAR)
...
#pragma region Protected members and data
	 ...
	 * \param	LineEndMode		Text file end of line termination mode. Default Text
	...
	*
	* \param	nchars			Position we which we want to position the cursor.
	*
