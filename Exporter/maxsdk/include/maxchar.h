...
public:
	...
	/**
	 * Create a character with a single-byte ACP character.
	 *
	...
	/* Create a character with the first character of a ACP String. */
	Char(const char*);

	/* Create a character with the first character of a CP String. */
	Char(unsigned int cp, const char*);
...
public:
	...
	/**
	 * Convert this character to an MCHAR (ACP or UTF16).
