...
#pragma deprecated("IPFVIEWPORT_EXTENTION_INTERFACE_ID")

/**	\deprecated. Deprecated class in 3ds Max 2013.
	Please use IPFViewportExtension2 instead
*/
...
#pragma warning( disable : 4481 )
	virtual bool UpdateDisplay(
		ULONG, 
		const MaxSDK::Graphics::MaterialRequiredStreams&, 
		TimeValue, 
		IObject*, 
		Object*, 
		MaxSDK::Graphics::RenderItemHandleArray &, 
		Tab<Matrix3>&) sealed
	{
		return false;
	}
