...
#  define assert( expr )    ( (expr) || assert1( __LINE__, _M(__FILE__), _M(__FUNCTION__), (_M(#expr)) ) )
#  define DbgAssert( expr ) ( (expr) || assert1( __LINE__, _M(__FILE__), _M(__FUNCTION__), (_M(#expr)) ) )
#  define DbgVerify( expr ) ( (expr) || assert1( __LINE__, _M(__FILE__), _M(__FUNCTION__), (_M(#expr)) ) )
