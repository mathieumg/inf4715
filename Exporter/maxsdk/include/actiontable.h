...
public:
	...
	CoreExport virtual int  GetId();
	CoreExport virtual void SetId(int id);

	CoreExport virtual const MCHAR*  GetDescription();
	CoreExport virtual void    SetDescription(const MCHAR* pDesc);

	CoreExport virtual const MCHAR*  GetShortName();
	CoreExport virtual void    SetShortName(const MCHAR* pShortName);

	CoreExport virtual const MCHAR*  GetCategory();
	CoreExport virtual void    SetCategory(const MCHAR* pCategory);	

	CoreExport virtual BOOL ExecuteAction();

	CoreExport virtual void GetButtonText(MSTR& buttonText);
	CoreExport virtual void GetMenuText(MSTR& menuText);
	CoreExport virtual void GetDescriptionText(MSTR& descText);
	CoreExport virtual void GetCategoryText(MSTR& catText);

	CoreExport virtual BOOL IsChecked();
	CoreExport virtual BOOL IsItemVisible();
	CoreExport virtual BOOL IsEnabled();
	...
	CoreExport virtual MSTR& GetPersistentActionId();
	CoreExport virtual void SetActionTableId( ActionTableId id );
	CoreExport virtual ActionTableId GetActionTableId();
	CoreExport virtual MSTR& GetPrefixString();
