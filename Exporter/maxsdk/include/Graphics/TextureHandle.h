...
How to use:
\code
TextureHandlep hTexture;
hTexture.Initialize(100, 100, TextureFormatA8R8G8B8);
LockedRect lockedRect;
hTexture.LockRect(0, lockedRect, NULL);
...
public:
	...
	/** Initialize the instance of texture.
	...
	\param[in] format member of the TextureFormat enumerated type, describing the pixel format of the texture.
	...
	*/
	...
	\param[in] level it specifies the level of the texture resource to lock. It's reserved. Set 0 as default.
