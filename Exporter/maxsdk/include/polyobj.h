...
/** \deprecated Deprecated method in terms of implementation as of 3ds Max 2013
	Please use UpdatePolyObjectDisplay() instead.
*/
MAX_DEPRECATED PolyLibExport void UpdateDisplayRequirements(MNMesh& mesh, unsigned long &requirementFlags);

// Currently for internal use only. We use it to update requirementFlags according to
// the current mesh when executing PolyObject::UpdateDisplay()
