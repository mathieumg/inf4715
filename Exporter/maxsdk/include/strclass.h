...
//-----------------------------------------------------------------------
/*! \sa  Class WStr, UTF8Str and MaxString, <a href="ms-its:3dsmaxsdk.chm::/ui_character_strings.html">Character Strings</a>.\n\n
\par Description:
...
class UtilExport CStr: public MaxHeapOperators {
	...
	public:
		...
		/*! \deprecated Deprecated in 3ds Max 2013, use CStr::FromUTF16() or CStr::FromBSTR() instead if have
		wchar_t* pointer, use WStr::ToCStr() if have WStr value.
		Constructor. The string is initialized to the string passed. */
//		MAX_DEPRECATED CStr(const wchar_t *wcstr);
		...
		/*! \remarks Returns a pointer to this string. But the returned string can be modified
		 *           safely up to nchars. */
		...
		*/
		...
		/*! \deprecated Deprecated in 3ds Max 2013, use CStr::FromUTF16() or CStr::FromBSTR() instead if have
		wchar_t* pointer, use WStr::ToACP() if have WStr value.
		Assignment operator. */
//		MAX_DEPRECATED CStr & operator=(const wchar_t *wcstr);
...
//-----------------------------------------------------------------------
/*! \sa  Class CStr, WStr and MaxString, <a href="ms-its:3dsmaxsdk.chm::/ui_character_strings.html">Character Strings</a>.\n\n
\par Description:
...
//-----------------------------------------------------------------------
/*! \sa  Class CStr, UTF8Str and MaxString, <a href="ms-its:3dsmaxsdk.chm::/ui_character_strings.html">Character Strings</a>.\n\n
\par Description:
...
class UtilExport WStr: public MaxHeapOperators {
	...
	public:
		...
		/*! \deprecated Deprecated in 3ds Max 2013, use WStr::FromACP(), WStr::FromUTF8(), WStr::FromCP(), or WStr::FromMCHAR() 
		instead if have char* pointer, use CStr::ToWStr() if have CStr value.
		Constructor. The string is initialized to the string passed. */
//		MAX_DEPRECATED WStr(const char *cs);
		...
		/*! \deprecated Deprecated in 3ds Max 2013, use WStr::FromACP(), WStr::FromUTF8(), WStr::FromCP(), or WStr::FromMCHAR() 
		instead if have char* pointer, use WStr::ToMCHAR() if have WStr value.
		Assignment operator. */
//		MAX_DEPRECATED WStr & operator=(const char *cstr);
...
Instead, use MaxSDK::TextFile::Writer, preferrably with UTF8 encoding and a UTF8 BOM.
!*/
