...
#pragma warning( disable : 4481 )
	...
	virtual int SaveToFile( MCHAR * fileName, FileIOType context ) sealed { 
...
#pragma warning( disable : 4481 )
	...
	virtual int LoadFromFile( MCHAR * fileName, FileIOType context ) sealed { 
		return LoadFromFile(const_cast<const MCHAR*>(fileName), context); }
#pragma warning( pop )
