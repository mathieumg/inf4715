...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual HWND AddTabRollupPage(const Class_ID& id, HINSTANCE hInst, MCHAR *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) sealed { 
		return AddTabRollupPage(id, hInst, const_cast<const MCHAR*>(dlgTemplate), dlgProc, const_cast<const MCHAR*>(title), param, flags, category); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual HWND AddTabRollupPage(const Class_ID& id, HINSTANCE hInst, DLGTEMPLATE *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) sealed { 
		return AddTabRollupPage(id, hInst, dlgTemplate, dlgProc, const_cast<const MCHAR*>(title), param, flags, category); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	...
	virtual int RenderPresetsMapCategoryToIndex( MCHAR* category ) sealed { return RenderPresetsMapCategoryToIndex( const_cast<const MCHAR*>(category));}
#pragma warning( pop )
