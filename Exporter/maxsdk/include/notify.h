...
//! \deprecated Deprecated in 3ds Max 2013. This notification code is not used in the product.
#pragma deprecated("NOTIFY_HEIGHT_CHANGED")
...
/** callParam is pointer to struct{ const MCHAR* oldname; const MCHAR* newname; INode* node} */
...
All the SceneState notifications have CallParam as a const MCHAR* with the SceneState name except 
...
/** \brief This provides a notification that a toolbar configuration is being loaded, prior to load.
    \callParam MCHAR* - NULL if default load file, or the full path to the file being loaded
*/
...
/*! the callParam is a pointer to the string(i.e., const MCHAR*) of the name of the created named set.
*/
...
/*! the callParam is a pointer to the string(i.e., const MCHAR*) of the name of the deleted named set.
*/
...
/*! the callParam is a pointer to the string(i.e., const MCHAR*) of the name of the modified named set.
...
#define NOTIFY_PRE_NODE_BONE_PROP_CHANGED		0x00000081 //!< Sent before an INode's bone property is changed.
#define NOTIFY_POST_NODE_BONE_PROP_CHANGED		0x00000082 //!< Sent after an INode's bone property is changed.
...
/** Sent after keyboard shortcut setting file(*.kbd) has changed. For example, loading/saving a new keyboard setting file.
*/
...
/** \brief This provides a notification that a toolbar configuration is being saved, prior to save.
	\callParam MCHAR* - NULL if default save file, or the full path to the file being saved
*/
