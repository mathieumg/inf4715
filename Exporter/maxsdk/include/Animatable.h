...
//@}
		...
		*/
		...
		\code
		INTERP_CONT_TEMPLATE
		int InterpControl<INTERP_CONT_PARAMS>::SetSelKeyCoordsExpr( ParamDimension *dim, const MCHAR *timeExpr, const MCHAR *valExpr, DWORD flags)
		{
			Expr texpr, vexpr;
...
#pragma warning( disable : 4481 )
		...
		virtual int SetSelKeyCoordsExpr(ParamDimension *dim, MCHAR *timeExpr, MCHAR *valExpr, DWORD flags) sealed {
				return SetSelKeyCoordsExpr(dim, const_cast<const MCHAR*>(timeExpr), const_cast<const MCHAR*>(valExpr), flags);
		}
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
		...
		virtual void EditTrackParams(
			...
			HWND hParent,
			IObjParam *ip,
			DWORD flags) sealed { EditTrackParams(t, dim, const_cast<const MCHAR*>(pname), hParent, ip, flags); }
#pragma warning( pop )
		...
		*/
		...
		\return  Returns true if a name is specified; otherwise false. */
