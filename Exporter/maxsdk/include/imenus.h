...
#pragma warning( disable : 4481 )
	...
	virtual void SetItemFontFace(MCHAR* szItemFontFace) sealed { SetItemFontFace(const_cast<const MCHAR*>(szItemFontFace)); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	virtual void SetTitleFontFace(MCHAR* szTitleFontFace) sealed { SetTitleFontFace(const_cast<const MCHAR*>(szTitleFontFace)); }
#pragma warning( pop )
