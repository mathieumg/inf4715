...
#pragma warning( disable : 4481 )
	 //! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	 virtual HWND AddRollupPage(HINSTANCE hInst, DLGTEMPLATE *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) sealed { 
		 return AddRollupPage(hInst, dlgTemplate, dlgProc, const_cast<const MCHAR*>(title), param, flags, category); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	 //! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	 virtual HWND ReplaceRollupPage(HWND hOldRollup, HINSTANCE hInst, MCHAR *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) sealed { 
		 return ReplaceRollupPage(hOldRollup, hInst, const_cast<const MCHAR*>(dlgTemplate), dlgProc, const_cast<const MCHAR*>(title), param, flags, category); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
	 //! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
	 virtual HWND ReplaceRollupPage(HWND hOldRollup, HINSTANCE hInst, DLGTEMPLATE *dlgTemplate, DLGPROC dlgProc, MCHAR *title, LPARAM param, DWORD flags, int category) sealed { 
		 return ReplaceRollupPage(hOldRollup, hInst, dlgTemplate, dlgProc, const_cast<const MCHAR*>(title), param, flags, category); }
#pragma warning( pop )
...
#pragma warning( disable : 4481 )
			//! \deprecated Deprecated method in terms of implementation as of 3ds Max 2013 - re-implement with const MCHAR* method signature
			virtual  void AddMapName(MCHAR *name) sealed { AddMapName(const_cast<const MCHAR*>(name)); }
#pragma warning( pop )
	 };
...
class Mtl: public MtlBase {
	 ...
	 public:
			...
			// Dynamics properties
			//! \deprecated Deprecated in 3ds Max 2013. No replacement.
