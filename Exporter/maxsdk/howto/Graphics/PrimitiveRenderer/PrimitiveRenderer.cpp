...
class PrimitiveRenderer : public SimpleObject2 {
	public:
		...
		virtual bool UpdateDisplay(const MaxSDK::Graphics::MaxContext& maxContext, 
...
bool PrimitiveRenderer::UpdateDisplay(const MaxSDK::Graphics::MaxContext& maxContext, 
	const MaxSDK::Graphics::UpdateDisplayContext& displayContext)
{
