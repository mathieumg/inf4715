...
public:
   ...
   ~CineonFile();
    ...
    BOOL    SetImageFileName(const ASCII*);
    BOOL    SetImageCreationDate(const ASCII*);
    BOOL    SetImageCreationTime(const ASCII*);
    BOOL    SetImageOffset(U32);
    BOOL    SetImageInputDevice(const ASCII*);
    BOOL    SetImageInputDeviceModelNumber(const ASCII*);
    BOOL    SetImageInputDeviceSerialNumber(const ASCII*);
