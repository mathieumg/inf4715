...
BOOL
CineonFile::SetImageFileName(const ASCII* filename)
{
...
BOOL
CineonFile::SetImageCreationDate(const ASCII* date)
{
...
BOOL
CineonFile::SetImageCreationTime(const ASCII* time)
{
...
BOOL
CineonFile::SetImageInputDevice(const ASCII* device)
{
...
BOOL
CineonFile::SetImageInputDeviceModelNumber(const ASCII* model)
{
...
BOOL
CineonFile::SetImageInputDeviceSerialNumber(const ASCII* serial)
{
