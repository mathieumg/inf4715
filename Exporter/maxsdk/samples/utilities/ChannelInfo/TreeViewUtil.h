...
class MapChannelDelete : public Modifier {
	public:
		...
		// From Animatable
		const TCHAR *GetObjectName() { return GetString(IDS_MAPCHANNELDELETENAME); }
...
class MapChannelPaste : public Modifier {
	public:
		...
		// From Animatable
		const TCHAR *GetObjectName() { return GetString(IDS_MAPCHANNELPASTENAME); }
...
class MapChannelAdd : public Modifier {
	public:
		...
		// From Animatable
		const TCHAR *GetObjectName() { return GetString(IDS_MAPCHANNELADDNAME); }
...
class SelectByChannel : public Modifier {
	public:
		...
		// From Animatable
		const TCHAR *GetObjectName() { return GetString(IDS_SELECTBYCHANNELNAME); }
