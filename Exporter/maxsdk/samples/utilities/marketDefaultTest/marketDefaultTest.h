...
class MarketDefaultTest : public UtilityObj,public FPStaticInterface, public MaxSDK::Util::Noncopyable 
{
public:
	enum {
		kTestAll,
	...
	DECLARE_DESCRIPTOR_INIT_NDC(MarketDefaultTest)
	BEGIN_FUNCTION_MAP
	...
	static MarketDefaultTest theInstance;
...
private:
	...
	static INT_PTR CALLBACK MarketDefaultTestDlgProc(
			HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam);
	static INT_PTR CALLBACK StatusDialogProc(
			HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam);
