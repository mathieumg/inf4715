...
void Gnormal::GetClassName(TSTR& s)
{
	s = GetString(IDS_GN_CLASS_NAME_IMP);
}
...
{	
	switch (i) 
	{
	case 0: return TSTR(GetString(IDS_GN_MAP_NORMAL));
	case 1: return TSTR(GetString(IDS_GN_MAP_BUMP));
