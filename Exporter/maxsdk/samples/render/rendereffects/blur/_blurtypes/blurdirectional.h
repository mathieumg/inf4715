...
protected:
	...
	bool do1DBoxRot(CompMap *pCompMap, BitmapAccessor &bmFrom, BitmapAccessor &bmTo );
	bool do1DBoxNoRot(CompMap *pCompMap, BitmapAccessor &bmFrom, BitmapAccessor &bmTo );
	bool do2DBoxRot(CompMap *pCompMap, BitmapAccessor &bmFrom, BitmapAccessor &bmTo );
	bool do2DBoxNoRot(CompMap *pCompMap, BitmapAccessor &bmFrom, BitmapAccessor &bmTo );
	virtual bool doBlur( CompMap *pCompMap, BitmapAccessor &bmFrom, BitmapAccessor &bmTo );
...
public:
	...
	~BlurDirectional();
	virtual void notifyPrmChanged(ParamID prmID);
