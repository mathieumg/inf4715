...
class GenericKernel: public FilterKernel {
	public:
		...
		virtual const TCHAR *GetObjectName() { return NULL; } // dummy, overridden by subclass
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_AREA_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_PIXELSIZE_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_CONE_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_QUADRATIC_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_CUBIC_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_CATROM_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_GAUSS_NARROW_KERNEL); }
		long GetKernelSupport() { return 1; };
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_GAUSS_MEDIUM_KERNEL); }
		long GetKernelSupport() { return 1; };
		void GetKernelSz( double& x, double& y ){ x = 1.5; y = 0.0; }
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_GAUSS_WIDE_KERNEL); }
		long GetKernelSupport() { return 2; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_PAVIC_UNITVOL_KERNEL); }
		long GetKernelSupport() { return 1; };
		void GetKernelSz( double& x, double& y ){ x = 1.0; y = 0.0; }
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_PAVIC_OP_KERNEL); }
		long GetKernelSupport() { return 1; };
		void GetKernelSz( double& x, double& y ){ x = 1.0; y = 0.0; }
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_HANNING_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_HAMMING_KERNEL); }
		long GetKernelSupport() { return 2; };
		bool HasNegativeLobes(){ return TRUE; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_BLACKMAN_KERNEL); }
		bool HasNegativeLobes(){ return TRUE; };
		long GetKernelSupport() { return 2; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_BLACKMAN361_KERNEL); }
		long GetKernelSupport() { return 2; };
		bool HasNegativeLobes(){ return TRUE; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_BLACKMAN367_KERNEL); }
		bool HasNegativeLobes(){ return TRUE; };
		long GetKernelSupport() { return 2; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_BLACKMAN474_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_BLACKMAN492_KERNEL); }
		long GetKernelSupport() { return 2; };
		bool HasNegativeLobes(){ return TRUE; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_MAX1_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_MAX2_KERNEL); }
		long GetKernelSupport() { return 1; };
		void GetKernelSz( double& x, double& y ){ x = 1.4; y = 0.0; }
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_MAX3_KERNEL); }
		long GetKernelSupport() { return 1; };
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_MITNET_OP_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_NTSC_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_MITNET_NOTCH_KERNEL); }
		long GetKernelSupport() { return 2; };
		bool HasNegativeLobes(){ return TRUE; };
		RefTargetHandle Clone(RemapDir& remap)
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_COOK_OP_KERNEL); }
		long GetKernelSupport() { return 2; }
		void GetKernelSz( double& x, double& y ){ x = 1.5; y = 0.0; }
		RefTargetHandle Clone(RemapDir& remap)
...
class CylinderVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_CYLINDER_VAR_KERNEL); }
...
class ConeVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_CONE_VAR_KERNEL); }
...
class QuadraticVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_QUADRATIC_VAR_KERNEL); }
		long GetKernelSupport() { return long( w + 0.5 ); }
		bool IsVariableSz(){ return TRUE; };
		// 1-D filters ignore the y parameter
...
class CubicVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_CUBIC_VAR_KERNEL); }
		long GetKernelSupport() { return long( w + 0.5 ); }
		bool IsVariableSz(){ return TRUE; };
		// 1-D filters ignore the y parameter
...
class CookVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_COOK_VAR_KERNEL); }
...
class GaussVarFilterKernel : public GenericKernel {
	...
	public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_GAUSS_VAR_KERNEL); }
...
//		FilterKernelParamDlg * CreateParamDialog(IRendParams *ip);
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_MITNET_VAR_KERNEL); }
		const TCHAR * GetDefaultComment() { return GetString(IDS_KE_MITNET_COMMENT); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_STOCKING_KERNEL); }
...
public:
		...
		const TCHAR *GetObjectName()  { return GetString(IDS_KE_BLEND_KERNEL); }
