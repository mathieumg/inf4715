...
namespace MXS_dotNet
{
	...
	public:
		...
		static Value* WrapType(const MCHAR* pTypeString); // Finds and wraps type, returns dotNetObject
		...
		bool show_properties(const MCHAR* pattern, CharStream* out, bool showStaticOnly, bool showMethods, bool showAttributes, bool declaredOnTypeOnly);
		bool show_methods(const MCHAR* pattern, CharStream* out, bool showStaticOnly, bool showSpecial, bool showAttributes, bool declaredOnTypeOnly);
		bool show_events(const MCHAR* pattern, CharStream* out, bool showStaticOnly, bool declaredOnTypeOnly);
		bool show_fields(const MCHAR* pattern, CharStream* out, bool showStaticOnly, bool showAttributes, bool declaredOnTypeOnly);
		/*
		// see comments in utils.cpp
		bool show_interfaces(const MCHAR* pattern, CharStream* out);
		void get_interfaces(Array* result);
		bool show_attributes(const MCHAR* pattern, CharStream* out, bool declaredOnTypeOnly);
		...
		*/
		...
		bool HasEvent(const MCHAR *eventName);
