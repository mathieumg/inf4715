...
visible_class_instance (MXS_dotNet::dotNetMXSValue, "dotNetMXSValue")
...
{
	// dtor can't safely access other mxs Values during shutdown because those Values 
	// may have already been deleted.
	if (Collectable::state == closing_down)
	{
