...
Value* DotNetObjectWrapper::WrapType(const MCHAR* pTypeString)
{
...
bool DotNetObjectWrapper::show_properties(const MCHAR* pattern, CharStream* out, 
...
bool DotNetObjectWrapper::show_methods(const MCHAR* pattern, CharStream* out, 
...
bool DotNetObjectWrapper::show_events(const MCHAR* pattern, CharStream* out, bool showStaticOnly, bool declaredOnTypeOnly)
{
	try
	{
		System::Type ^ type = GetType();
...
bool DotNetObjectWrapper::show_fields(const MCHAR* pattern, CharStream* out, bool showStaticOnly, bool showAttributes, bool declaredOnTypeOnly)
{
	try
	{
		System::Type ^ type = GetType();
...
bool DotNetObjectWrapper::show_interfaces(const MCHAR* pattern, CharStream* out)
{
	try
	{
		System::Type ^ type = GetType();
...
bool DotNetObjectWrapper::show_attributes(const MCHAR* pattern, CharStream* out, bool declaredOnTypeOnly)
{
	try
	{
		System::Type ^ type = GetType();
...
bool DotNetObjectWrapper::HasEvent(const MCHAR *eventName)
{
	using namespace System;
	using namespace System::Reflection;
