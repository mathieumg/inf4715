...
meshop_getFaceCenter_cf(Value** arg_list, int count)
{
	...
	range_check(faceIndex+1, 1, mesh->getNumFaces(), MaxSDK::GetResourceStringAsMSTR(IDS_MESH_FACE_INDEX_OUT_OF_RANGE))
...
meshop_minVertexDistanceFrom_cf(Value** arg_list, int arg_count)
{
	...
	int nVerts=mesh->getNumVerts();
	range_check(vertIndex+1, 1, nVerts, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_VERTEX_INDEX_OUT_OF_RANGE))
...
//	else world_from_current_coordsys(normal,NO_TRANSLATE + NO_SCALE);
	int nEdges = 3*mesh->getNumFaces();
	range_check(edge1Index+1, 1, nEdges, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_EDGE_INDEX_OUT_OF_RANGE))
	range_check(edge2Index+1, 1, nEdges, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_EDGE_INDEX_OUT_OF_RANGE))
	Value* tmp;
...
meshop_getVert_cf(Value** arg_list, int count)
{
	...
	int vertIndex =  arg_list[1]->to_int()-1;
	range_check(vertIndex+1, 1, mesh->getNumVerts(), MaxSDK::GetResourceStringAsMSTR(IDS_MESH_VERTEX_INDEX_OUT_OF_RANGE))
...
meshop_divideFaceByEdges_cf(Value** arg_list, int count)
{
	...
	int nFaces = mesh->getNumFaces();
	range_check(faceIndex+1, 1, nFaces, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_FACE_INDEX_OUT_OF_RANGE))
	range_check(edge1Index+1, 1, 3*nFaces, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_EDGE_INDEX_OUT_OF_RANGE))
	range_check(edge2Index+1, 1, 3*nFaces, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_EDGE_INDEX_OUT_OF_RANGE))
	Value* tmp;
	bool fixNeighbors = bool_key_arg(fixNeighbors, tmp, TRUE) == TRUE; 
	bool split = bool_key_arg(split, tmp, FALSE) == TRUE; 
	MeshDeltaUser *mdu = (owner) ? GetMeshDeltaUserInterface(owner) : NULL;
...
{	
	...
	range_check(edgeIndex+1, 1, 3*mesh->getNumFaces(), MaxSDK::GetResourceStringAsMSTR(IDS_MESH_EDGE_INDEX_OUT_OF_RANGE)) 
	MeshDeltaUser *mdu = (owner) ? GetMeshDeltaUserInterface(owner) : NULL;
	if (mdu && mdu->Editing()) mdu->ExitCommandModes();
...
// Note: can have map verts without having map faces
	...
	range_check(channel, -NUM_HIDDENMAPS, MAX_MESHMAPS-1, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_MAP_CHANNEL_OUT_OF_RANGE));
...
meshop_setNumMaps_cf(Value** arg_list, int count)
{
	...
	range_check(numMaps, 0, MAX_MESHMAPS, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_NUMMAPS_OUT_OF_RANGE));
	Value* tmp;
...
meshop_setMapSupport_cf(Value** arg_list, int arg_count)
{
	...
	range_check(channel, -NUM_HIDDENMAPS, mesh->getNumMaps()-1, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_MAP_CHANNEL_OUT_OF_RANGE));
...
// can have map verts without having map faces
	...
	if (!mesh->mapSupport(channel))
		throw RuntimeError (MaxSDK::GetResourceStringAsMSTR(IDS_MAP_SUPPORT_NOT_ENABLED_FOR_CHANNEL), arg_list[1]);
	range_check(index+1, 1, mesh->getNumMapVerts(channel), MaxSDK::GetResourceStringAsMSTR(IDS_MESH_MAP_VERTEX_INDEX_OUT_OF_RANGE));
	MeshDeltaUser *mdu = (owner) ? GetMeshDeltaUserInterface(owner) : NULL;
	if (mdu && mdu->Editing()) mdu->ExitCommandModes();
...
meshop_setMapFace_cf(Value** arg_list, int arg_count)
{
	...
	if (!mesh->mapSupport(channel))
		throw RuntimeError (MaxSDK::GetResourceStringAsMSTR(IDS_MAP_SUPPORT_NOT_ENABLED_FOR_CHANNEL), arg_list[1]);
	range_check(index+1, 1, GetNumMapFaces(mesh, channel), MaxSDK::GetResourceStringAsMSTR(IDS_MESH_MAP_FACE_INDEX_OUT_OF_RANGE));
	IPoint3 faceVertsI ((int)faceVerts.x-1, (int)faceVerts.y-1, (int)faceVerts.z-1);
	int nMapVerts = mesh->getNumMapVerts(channel);
	range_check(faceVertsI.x+1, 1, nMapVerts, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_MAP_VERTEX_INDEX_OUT_OF_RANGE));
	range_check(faceVertsI.y+1, 1, nMapVerts, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_MAP_VERTEX_INDEX_OUT_OF_RANGE));
	range_check(faceVertsI.z+1, 1, nMapVerts, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_MAP_VERTEX_INDEX_OUT_OF_RANGE));
	MeshDeltaUser *mdu = (owner) ? GetMeshDeltaUserInterface(owner) : NULL;
	if (mdu && mdu->Editing()) mdu->ExitCommandModes();
...
{	
	...
	int channel = arg_list[1]->to_int();
	range_check(channel, 0, MAX_MESHMAPS-1, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_MAP_CHANNEL_OUT_OF_RANGE));
	if (!mesh->mapSupport(channel))
		throw RuntimeError (MaxSDK::GetResourceStringAsMSTR(IDS_MAP_SUPPORT_NOT_ENABLED_FOR_CHANNEL), arg_list[1]);
	MeshDeltaUser *mdu = (owner) ? GetMeshDeltaUserInterface(owner) : NULL;
	if (mdu && mdu->Editing()) mdu->ExitCommandModes();
...
{	
	...
	int vertIndex =  arg_list[1]->to_int()-1;
	range_check(vertIndex+1, 1, mesh->vData[VDATA_WEIGHT].Count(), MaxSDK::GetResourceStringAsMSTR(IDS_MESH_VERTDATA_INDEX_OUT_OF_RANGE))
...
{	
	...
	int vertIndex =  arg_list[1]->to_int()-1;
	range_check(vertIndex+1, 1, mesh->vData[VDATA_SELECT].Count(), MaxSDK::GetResourceStringAsMSTR(IDS_MESH_VERTDATA_INDEX_OUT_OF_RANGE))
...
{	
	...
	int vertIndex =  arg_list[1]->to_int()-1;
	range_check(vertIndex+1, 1, mesh->vData[VDATA_CORNER].Count(), MaxSDK::GetResourceStringAsMSTR(IDS_MESH_VERTDATA_INDEX_OUT_OF_RANGE))
...
{	
	...
	int vertIndex =  arg_list[1]->to_int()-1;
	range_check(vertIndex+1, 1, mesh->vData[VDATA_ALPHA].Count(), MaxSDK::GetResourceStringAsMSTR(IDS_MESH_VERTDATA_INDEX_OUT_OF_RANGE))
...
meshop_setNumVDataChannels_cf(Value** arg_list, int count)
{
	...
	range_check(numChannels, 0, MAX_VERTDATA, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_NUMVERTDATA_OUT_OF_RANGE));
	Value* tmp;
	bool keep = bool_key_arg(keep, tmp, TRUE) == TRUE; 
	MeshDeltaUser *mdu = (owner) ? GetMeshDeltaUserInterface(owner) : NULL;
	if (mdu && mdu->Editing()) mdu->ExitCommandModes();
...
meshop_setVDataChannelSupport_cf(Value** arg_list, int count)
{
	...
	range_check(vdChannel+1, 1, MAX_VERTDATA, MaxSDK::GetResourceStringAsMSTR(IDS_MESH_VERTDATA_CHANNEL_OUT_OF_RANGE));
	MeshDeltaUser *mdu = (owner) ? GetMeshDeltaUserInterface(owner) : NULL;
	if (mdu && mdu->Editing()) mdu->ExitCommandModes();
...
meshop_getVDataValue_cf(Value** arg_list, int count)
{
	...
	int index=arg_list[2]->to_int()-1;
	range_check(index+1, 1, mesh->vData[vdChannel].Count(), MaxSDK::GetResourceStringAsMSTR(IDS_MESH_VERTDATA_INDEX_OUT_OF_RANGE));
