...
extern void		ValueToBitArray(Value* inval, BitArray &theBitArray, int maxSize, const TCHAR* errmsg=_T(""), int selTypesAllowed=0);
extern void		ValueToBitArrayM(Value* inval, BitArray &theBitArray, int maxSize, const TCHAR* errmsg, int selTypesAllowed, Mesh* mesh);
extern void		ValueToBitArrayP(Value* inval, BitArray &theBitArray, int maxSize, const TCHAR* errmsg, int selTypesAllowed, MNMesh* poly);
