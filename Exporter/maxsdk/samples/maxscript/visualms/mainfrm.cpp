...
int CMainFrame::CreatePropBar()
{
   ...
   m_propBar.AddView(MaxSDK::GetResourceStringAsMSTR(IDS_PROPERTIES), RUNTIME_CLASS(CPropView), pDoc);
   m_propBar.AddView(MaxSDK::GetResourceStringAsMSTR(IDS_EVENTS), RUNTIME_CLASS(CEventView), pDoc);
