...
int CPropView::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	GetListCtrl().InsertColumn(0, MaxSDK::GetResourceStringAsMSTR(IDS_PROPERTY), LVCFMT_LEFT, 80, -1);
	GetListCtrl().InsertColumn(1, MaxSDK::GetResourceStringAsMSTR(IDS_VALUE), LVCFMT_LEFT, 80, -1);
