...
void BonesCreateMode::ReadINI(BoneData &data)
{
	...
	GetPrivateProfileString(BONE_OBJECT,BONE_WIDTH, buffer, buffer, bufLen, filename);
    data.boneObjWidth=  _tstof(buffer);
	GetPrivateProfileString(BONE_OBJECT,BONE_HEIGHT, buffer, buffer, bufLen, filename);
    data.boneObjHeight=  _tstof(buffer);
	GetPrivateProfileString(BONE_OBJECT,BONE_TAPER, buffer, buffer, bufLen, filename);
    data.boneObjTaper=  _tstof(buffer);

	GetPrivateProfileString(BONE_SIDE_FINS,BONE_ENABLED, buffer, buffer, bufLen, filename);
    data.boneObjSideFinsEnabled = (BOOL) _ttoi(buffer);
	GetPrivateProfileString(BONE_SIDE_FINS,BONE_SIZE, buffer, buffer, bufLen, filename);
    data.boneObjSideFinsSize=  _tstof(buffer);
	GetPrivateProfileString(BONE_SIDE_FINS,BONE_START_TAPER, buffer, buffer, bufLen, filename);
    data.boneObjSideFinsStartTaper=  _tstof(buffer);
	GetPrivateProfileString(BONE_SIDE_FINS,BONE_END_TAPER, buffer, buffer, bufLen, filename);
    data.boneObjSideFinsEndTaper=  _tstof(buffer);


	GetPrivateProfileString(BONE_FRONT_FIN,BONE_ENABLED, buffer, buffer, bufLen, filename);
    data.boneObjFrontFinEnabled = (BOOL) _ttoi(buffer);
	GetPrivateProfileString(BONE_FRONT_FIN,BONE_SIZE, buffer, buffer, bufLen, filename);
    data.boneObjFrontFinSize=  _tstof(buffer);
	GetPrivateProfileString(BONE_FRONT_FIN,BONE_START_TAPER, buffer, buffer, bufLen, filename);
    data.boneObjFrontFinStartTaper=  _tstof(buffer);
	GetPrivateProfileString(BONE_FRONT_FIN,BONE_END_TAPER, buffer, buffer, bufLen, filename);
    data.boneObjFrontFinEndTaper=  _tstof(buffer);

	
	GetPrivateProfileString(BONE_BACK_FIN,BONE_ENABLED, buffer, buffer, bufLen, filename);
    data.boneObjBackFinEnabled = (BOOL) _ttoi(buffer);
	GetPrivateProfileString(BONE_BACK_FIN,BONE_SIZE, buffer, buffer, bufLen, filename);
    data.boneObjBackFinSize=  _tstof(buffer);
	GetPrivateProfileString(BONE_BACK_FIN,BONE_START_TAPER, buffer, buffer, bufLen, filename);
    data.boneObjBackFinStartTaper=  _tstof(buffer);
	GetPrivateProfileString(BONE_BACK_FIN,BONE_END_TAPER, buffer, buffer, bufLen, filename);
    data.boneObjBackFinEndTaper=  _tstof(buffer);

	GetPrivateProfileString(BONE_MAP_COORDINATES,BONE_ENABLED, buffer, buffer, bufLen, filename);
