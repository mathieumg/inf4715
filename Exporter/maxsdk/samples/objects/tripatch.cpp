...
class TriPatchObject: public GeomObject, public IParamArray  {			   
	...
	public:
		...
		const TCHAR *GetObjectName() { return GetString(IDS_TH_TRIPATCH); }
		...
		void GetClassName(TSTR& s) { s = GetString(IDS_TH_TRIPATCHOBJECT_CLASS); }		
...
// from IDisplay
bool TriPatchObject::RequiresSupportForLegacyDisplayMode() const
{
	return true ;
}
