...
#define MAXVER_INTERNALNAME "EggShape\0"//should  be overidden on a per-dll level
#define MAXVER_ORIGINALFILENAME "EggShape.dlo\0"//should  be overidden on a per-dll level
#define MAXVER_FILEDESCRIPTION "Egg Shape Object (plugin)\0"//should  be overidden on a per-dll level
