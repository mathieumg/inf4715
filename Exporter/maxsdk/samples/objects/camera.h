...
// mjm - end
	...
	const TCHAR *GetObjectName() { return hasTarget ? GetString(IDS_DB_TARGET_CAM) : GetString(IDS_DB_FREE_CAM); }
	...
	void GetClassName(TSTR& s) { s = GetString(IDS_DB_SIMPLECAM_CLASS); }
...
//			case 2:
// nac - end
				return GetString(IDS_MP_EFFECT);
// mjm - end
#endif // NO_CAMERA_MULTIPASS
			default:
				return _T("");
