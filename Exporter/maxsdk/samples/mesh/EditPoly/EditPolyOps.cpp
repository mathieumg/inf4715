...
public:
	PolyOpChamferEdge () : mAmount(0.0f), mOpen(false), mSegments(1),mChamferEdgeGrip(NULL) { }
	~PolyOpChamferEdge() { }
	// Implement PolyOperation methods:
...
public:
	PolyOpExtrudeFace () : mHeight(0.0f), mType(0), mExtrudeFaceGrip(NULL) { }
	~PolyOpExtrudeFace(){ }
...
public:
	PolyOpBevelFace () : mHeight(0.0f), mOutline(0.0f), mType(0), mBevelGrip(NULL) { }
	~PolyOpBevelFace (){ }
	// Implement PolyOperation methods:
...
public:
	PolyOpInsetFace () : mAmount(0.0f), mType(0),mInsetGrip(NULL) { }
	~PolyOpInsetFace(){ }
...
public:
	PolyOpOutlineFace () : mAmount(0.0f),mOutlineGrip(NULL) { }
	~PolyOpOutlineFace(){}
