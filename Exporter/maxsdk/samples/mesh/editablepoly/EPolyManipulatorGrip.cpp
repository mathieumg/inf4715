...
void EPolyManipulatorGrip_Imp::LoadPreferences ()
{
	...
	if (NULL != pathMgr && pathMgr->DoesFileExist(iniFileName)) 
	{
		...
		if (GetPrivateProfileString(kINI_SECTION_NAME, kFALLOFF, defaultVal, buf, _countof(buf), iniFileName))
		{
			int val = _tstoi(buf);
		...
		if (GetPrivateProfileString(kINI_SECTION_NAME,kPINCH, defaultVal, buf, _countof(buf), iniFileName))
		{
			int val = _tstoi(buf);
		...
		if (GetPrivateProfileString(kINI_SECTION_NAME, kBUBBLE, defaultVal, buf, _countof(buf), iniFileName))
		{
			int val = _tstoi(buf);
		...
		if (GetPrivateProfileString(kINI_SECTION_NAME, kSETFLOW, defaultVal, buf, _countof(buf), iniFileName))
		{
			int val = _tstoi(buf);
		...
		if (GetPrivateProfileString(kINI_SECTION_NAME,kLOOPSHIFT, defaultVal, buf, _countof(buf), iniFileName))
		{
			int val = _tstoi(buf);
		...
		if (GetPrivateProfileString(kINI_SECTION_NAME, kRINGSHIFT, defaultVal, buf, _countof(buf), iniFileName))
		{
			int val = _tstoi(buf);
		...
		if (GetPrivateProfileString(kINI_SECTION_NAME, kEDGECREASE, defaultVal, buf, _countof(buf), iniFileName))
		{
			int val = _tstoi(buf);
		...
		if (GetPrivateProfileString(kINI_SECTION_NAME,kEDGEWEIGHT, defaultVal, buf, _countof(buf), iniFileName))
		{
			int val = _tstoi(buf);
		...
		if (GetPrivateProfileString(kINI_SECTION_NAME, kVERTEXWEIGHT, defaultVal, buf, _countof(buf), iniFileName))
		{
			int val = _tstoi(buf);
