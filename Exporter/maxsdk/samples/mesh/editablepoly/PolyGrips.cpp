...
bool ChamferVerticesGrip::ShowKeyBrackets(int which,TimeValue t)
{
	...
	case eChamferVerticesAmount:
		return (GetEditPolyObj()->getParamBlock()->KeyFrameAtTimeByID(ep_vertex_chamfer,t)==TRUE)? true : false;
	case eChamferVerticesOpen:
		return (GetEditPolyObj()->getParamBlock()->KeyFrameAtTimeByID(ep_vertex_chamfer_open,t)==TRUE) ? true : false;
	default:
		return false;
...
bool ChamferEdgeGrip::GetText(int which,TSTR &string)
{
	...
	case eChamferEdgeAmount:
		{
			string =GetString(IDS_EDGE_CHAMFER_AMOUNT);
		}
		break;
	case eChamferEdgeSegments:
		{
			string =GetString(IDS_CONNECT_EDGE_SEGMENTS);
		}
		break;
	case eChamferEdgeOpen:
		{
...
bool ChamferEdgeGrip::ShowKeyBrackets(int which,TimeValue t)
{
	...
	case eChamferEdgeAmount:
		return (GetEditPolyObj()->getParamBlock()->KeyFrameAtTimeByID(ep_edge_chamfer,t)==TRUE)? true : false;
	case eChamferEdgeSegments:
		return (GetEditPolyObj()->getParamBlock()->KeyFrameAtTimeByID(ep_edge_chamfer_segments,t)==TRUE) ? true : false;
	case eChamferEdgeOpen:
		return (GetEditPolyObj()->getParamBlock()->KeyFrameAtTimeByID(ep_edge_chamfer_open,t)==TRUE) ? true : false;
	default:
		return false;
	}
