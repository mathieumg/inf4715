...
void PainterInterface::LoadWinTabDLL()
	{
	hWinTabDLL = NULL;
	hWinTabDLL = LoadLibrary(_T("WINTAB32"));
	if (hWinTabDLL)
		{
		PaintWTPacket = (WTPACKET)GetProcAddress(hWinTabDLL,"WTPacket");
#ifdef UNICODE
		PaintWTOpen = (WTOPEN)GetProcAddress(hWinTabDLL,"WTOpenW");
		PaintWTInfo = (WTINFO)GetProcAddress(hWinTabDLL,"WTInfoW");
#else
...
void* PainterInterface::GetInterface(ULONG id)
{
	switch(id)
	{
		...
		case PAINTERINTERFACE_V7 : return (IPainterInterface_V7*) this;
			break;
		case PAINTERINTERFACE_V14 : return (IPainterInterface_V14*) this;
			break;
