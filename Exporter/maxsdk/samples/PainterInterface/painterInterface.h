...
typedef HCTX (CALLBACK* WTOPEN)(HWND, LPLOGCONTEXT, BOOL);
...
class PainterInterface :  public ReferenceTarget, public IPainterInterface_V14, public ViewportDisplayCallback
	...
	public:	
		...
		void			GetClassName(TSTR& s) { s = _T("thePainterInterface"); }
