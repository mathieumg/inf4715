...
IEnumerable<ClassDescWrapper^>^ SunlightClassDescFactory::CreateClassDescs()
{
	return gcnew cli::array<ClassDescWrapper^> {
		...
		gcnew ClassDescOwner(new SlaveControlMatrix3ClassDesc()),
		gcnew ClassDescOwner(new LegacySlaveControlPosClassDesc()),
		gcnew ClassDescOwner(new SlaveControlFloatClassDesc()),
		gcnew ClassDescOwner(new DaySlaveControlMatrix3ClassDesc()),
		gcnew ClassDescOwner(new LegacyDaySlaveControlPosClassDesc()),
