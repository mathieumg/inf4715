...
public:
	...
	DWORD					m_errorFlags;
	TCHAR					m_cacheSignature[12];
	TCHAR					m_signature[12];
...
private:
	...
	// The KFbxSdkManager above owns this cache pointer. 
...
class OLDPointCacheBase : public Modifier {
	...
	public:
		...
		// From Animatable
		const TCHAR *GetObjectName() { return GetString(IDS_CLASS_NAME_OLD); }
