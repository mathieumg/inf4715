...
public:
	...
	const TCHAR *GetObjectName() { return GetString(IDS_EDIT_POLY_MOD); }
...
public:
	...
	virtual void* Parameter (ParamID i) { return NULL; }
	virtual int ParameterSize (ParamID i) { return sizeof(float); }	// note - also = sizeof(int).
