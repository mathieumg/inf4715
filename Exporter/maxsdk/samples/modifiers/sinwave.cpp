...
class SinWaveObject : public WaveObject {	
	public:				
		...
		const TCHAR *GetObjectName() {return GetString(IDS_RB_RIPPLE);}		
...
class LinWaveObject : public WaveObject {	
	public:		
		...
		const TCHAR *GetObjectName() { return GetString(IDS_RB_WAVE); }
...
class SinWaveMod : public WaveMod {
	public:		
		...
		RefTargetHandle Clone(RemapDir& remap);
		const TCHAR *GetObjectName() {return GetString(IDS_RB_RIPPLE_BINDING);}
...
class LinWaveMod : public WaveMod {
	public:		
		...
		RefTargetHandle Clone(RemapDir& remap);
		const TCHAR *GetObjectName() {return GetString(IDS_RB_WAVEBINDING);}
