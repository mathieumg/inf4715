...
class MatMod : public Modifier { 
   public:
      ...
      const TCHAR *GetObjectName() { return GetString(IDS_RB_MATERIAL3); }
...
public:
   ...
   void BeginEditParams( IObjParam  *ip, ULONG flags,Animatable *prev);
   void EndEditParams( IObjParam *ip,ULONG flags,Animatable *next);     
   const TCHAR *GetObjectName() { return GetString(IDS_RB_SMOOTH2); }
   CreateMouseCallBack* GetCreateMouseCallBack() {return NULL;} 
...
class NormalMod : public Modifier { 
   public:
      ...
      void BeginEditParams( IObjParam  *ip, ULONG flags,Animatable *prev);
      void EndEditParams( IObjParam *ip,ULONG flags,Animatable *next);     
      const TCHAR *GetObjectName() { return GetString(IDS_RB_NORMAL); }
      CreateMouseCallBack* GetCreateMouseCallBack() {return NULL;} 
