			...
			if ((mod->sketchSelMode == SKETCH_DRAWMODE) )
			{
				...
				else if (mod->sketchType == SKETCH_BOX)
				{
					if (drawPointCount == 1)
					{
						...
						points[0] = prevPoint;
						points[1] = om;
						XORDottedRect(hWnd, points[0],points[1], 0, true);
						points[0] = prevPoint;
						points[1] = m;
				...
				else if (mod->sketchType == SKETCH_CIRCLE)
				{
					if (drawPointCount == 1)
					{
						...
						points[0] = prevPoint;
						points[1] = om;
						XORDottedCircle(hWnd, points[0],points[1], 0, true);
						points[0] = prevPoint;
						points[1] = m;
	...
	HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	switch (msg) {
	  ...
	  case WM_SYSCOMMAND:
		  ...
		  {
			  MaxSDK::IHelpSystem::GetInstance()->ShowProductHelpForTopic(idh_unwrap_sketch); 
		  }
		  return FALSE;
		  break;
	  case WM_COMMAND:
