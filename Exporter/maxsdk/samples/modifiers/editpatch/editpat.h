...
public:
		...
		const TCHAR *GetObjectName() { return GetString(IDS_TH_EDITPATCH); }
...
class EPMapVertSizeValidator {
	EPMapVertSizeValidator() {}  // not creatable
	MaxSDK::Util::StaticAssert< (sizeof(EPMapVert) == (sizeof(int)+sizeof(Point3)+sizeof(DWORD))) > validator;
};
...
// saved as a binary blob to scene file. Changes in size will break file i/o
class EPMapPatchSizeValidator {
	EPMapPatchSizeValidator() {}  // not creatable
	MaxSDK::Util::StaticAssert< (sizeof(EPMapPatch) == (sizeof(int)+sizeof(DWORD))) > validator;
};
...
// saved as a binary blob to scene file. Changes in size will break file i/o
class EPMapUVVertSizeValidator {
	EPMapUVVertSizeValidator() {}  // not creatable
	MaxSDK::Util::StaticAssert< (sizeof(EPMapUVVert) == (sizeof(int)+sizeof(DWORD))) > validator;
};
