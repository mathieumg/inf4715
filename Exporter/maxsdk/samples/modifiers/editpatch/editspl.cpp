      ...
      for(int poly = 0; poly < polys; ++poly) {
         ...
         if(!spline->Closed()) {
            ...
            if(knots > 2 && (pSel[1] || pSel[(knots-1)*3+1])) {
               ...
               if(thePrompt.DoIt(vpt.ToPointer(), nodeTM, p1, p2)) {
                  // Start a restore object...
                  if ( theHold.Holding() )
                     theHold.Put(new ShapeRestore(shapeData,this,shape));
                  // Do the close
            ...
            if(pSel[1] || pSel[lastSel1]) {
               ...
               for(int poly2 = 0; poly2 < polys; ++poly2) {
                  ...
                  if(poly1 != poly2 && !spline2->Closed()) {
                     ...
                     int vert1, vert2;
                     if(pSel[1]) {
                        if(thePrompt.DoIt(vpt.ToPointer(), nodeTM, p3, p1)) {
                           vert1 = 0;
                           vert2 = 0;
                        ...
                        if(thePrompt.DoIt(vpt.ToPointer(), nodeTM, p4, p1)) {
                           vert1 = 0;
                           vert2 = knots2-1;
                           goto attach_it;
                           }
                     ...
                     if(pSel[lastSel1]) {
                        if(thePrompt.DoIt(vpt.ToPointer(), nodeTM, p3, p2)) {
                           vert1 = knots1-1;
                           vert2 = 0;
                           goto attach_it;
                           }
                        else
                        if(thePrompt.DoIt(vpt.ToPointer(), nodeTM, p4, p2)) {
                           vert1 = knots1-1;
                           vert2 = knots2-1;
                           goto attach_it;
                           }
