...
class WeightTableWindow :  public ViewWindow,
		public IViewWindowMetaDataProvider
{
...
//ActionItem methods
		...
		virtual void GetMenuText(TSTR& menuText)		{menuText.printf("%s",this->menuText);}
		virtual void GetButtonText(TSTR& buttonText)	{buttonText.printf("%s",this->buttonText);	}
		virtual void GetCategoryText(TSTR& catText)		{catText.printf("%s",this->catText);}
		virtual void GetDescriptionText(TSTR& descText) {descText.printf("%s",this->descText);}
