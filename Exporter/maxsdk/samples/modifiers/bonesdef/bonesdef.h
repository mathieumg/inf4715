...
typedef LinkedEntryT<BoneDataClass> BoneDataClassEntry;
typedef LinkedListT<BoneDataClass,BoneDataClassEntry> BoneDataClassList;
...
//					}
	...
	// Local methods for handling named selection sets
		...
		// BASEOBJECT METHODS
				...
				void SelectBoneByParmIndex(int paramBlockBoneIndex) ;
...
//gizmo stuff
				...
				const TCHAR *GetBoneName(int index);	//returns the bone name which is the node name now (was her to support our old bones)
