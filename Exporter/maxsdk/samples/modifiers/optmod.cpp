...
public:
		...
		const TCHAR *GetObjectName() { return GetString(IDS_RB_OPTIMIZE); }
...
public:
		...
		TSTR SubAnimName(int ) {return GetString(IDS_RB_PARAMETERS);}
		...
		case WM_COMMAND:
			switch (LOWORD(wParam)) {
				...
				case IDC_OPT_UPDATE:
					...
					mod->NotifyDependents(FOREVER,(PartID)PART_ALL,REFMSG_CHANGE);
