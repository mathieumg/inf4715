...
class FullRestore: public RestoreObj {
	public:		
		...
		void EndHold() {}
		TSTR Description() { return _T("FullReactorRestore"); }
	};
...
class StateRestore : public RestoreObj {
	public:
		...
		TSTR Description() { return _T("Reactor State"); }
};
...
class RangeRestore : public RestoreObj {
	public:
		...
		TSTR Description() { return _T("Reactor control range"); }
	};
...
class MasterStateRestore : public RestoreObj
{
	public:
		...
		TSTR Description() { return _T("Master State"); }
};
...
class MasterStateListRestore : public RestoreObj
{
	public:
		...
		TSTR Description() { return _T("Master State List"); }
};
...
class MasterIDRestore : public RestoreObj
{
	public:
		...
		TSTR Description() { return _T("Master IDs"); }
};
...
class DlgUpdateRestore : public RestoreObj
{
	public:
		...
		TSTR Description() { return _T("Update Reaction Dialog"); }
};
