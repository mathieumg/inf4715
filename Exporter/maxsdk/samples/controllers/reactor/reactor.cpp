...
SlaveState* Reactor::CreateReactionAndReturn(BOOL setDefaults, const TCHAR *buf, TimeValue t, int masterID)
{
...
void Reactor::EditTrackParams(TimeValue t,ParamDimensionBase *dim,const TCHAR *pname,
...
MasterState* ReactionMaster::AddState(const TCHAR* buf, int &id, bool setDefaults, TimeValue t)
{
	if (theHold.Holding())
