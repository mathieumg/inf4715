...
bool AnimPopupMenu::add_subanim_params(PickObjectCallback* cb, Tab<AnimEntry*>& wparams, const TCHAR* name, Tab<ReferenceTarget*>& parents, int level, Tab<ReferenceTarget*>& roots)
{
	bool subAdded = false;
