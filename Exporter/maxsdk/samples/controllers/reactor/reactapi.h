...
class IReactor : public Control, public FPMixinInterface 
{
	public:
		...
		virtual BOOL	CreateReaction(const TCHAR *buf=NULL, TimeValue t = GetCOREInterface()->GetTime())=0; 
#pragma warning( push )
#pragma warning( disable : 4481 )
		...
		virtual BOOL	CreateReaction(TCHAR *buf, TimeValue t) sealed { return CreateReaction(const_cast<const TCHAR*>(buf), t); }
#pragma warning( pop )
