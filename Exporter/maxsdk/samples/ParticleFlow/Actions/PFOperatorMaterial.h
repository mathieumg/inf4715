...
protected:
	virtual ParamID assignMtlParamID(void) const = 0;
	virtual ParamID mtlParamID(void) const = 0;
	virtual ParamID numSubMtlsParamID(void) const = 0;
	virtual ParamID randParamID(void) const = 0;
