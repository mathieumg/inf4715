...
static DisabledPropertyEntry gDisabledProperties[] = {
	...
	DisabledPropertyEntry( "PxJointLimit", "IsValid" ),
	DisabledPropertyEntry( "PxJointLimitPair", "IsValid" ),
...
#define DEFINE_SIM_STATS_DUAL_INDEXED_PROPERTY( propName, propType, fieldName ) CustomProperty("PxSimulationStatistics", #propName,	#propType, "PxU32 " #propName "[PxGeometryType::eGEOMETRY_COUNT][PxGeometryType::eGEOMETRY_COUNT];", "physx::shdfnd::memCopy( "#propName ", inSource->"#fieldName", sizeof( "#propName" ) );" )
	DEFINE_SIM_STATS_DUAL_INDEXED_PROPERTY( NumDiscreteContactPairs, NumDiscreteContactPairsProperty, numDiscreteContactPairs ),
	DEFINE_SIM_STATS_DUAL_INDEXED_PROPERTY( NumModifiedContactPairs, NumModifiedContactPairsProperty, numModifiedContactPairs),
	DEFINE_SIM_STATS_DUAL_INDEXED_PROPERTY( NumSweptIntegrationPairs, NumSweptIntegrationPairsProperty, numSweptIntegrationPairs),
	DEFINE_SIM_STATS_DUAL_INDEXED_PROPERTY( NumTriggerPairs, NumTriggerPairsProperty, numTriggerPairs),
#undef DEFINE_SIM_STATS_DUAL_INDEXED_PROPERTY
	CustomProperty( "PxSimulationStatistics",	"NumBroadPhaseAdds",		"NumBroadPhaseAddsProperty", "PxU32 NumBroadPhaseAdds[PxSimulationStatistics::eVOLUME_COUNT];", "physx::shdfnd::memCopy( NumBroadPhaseAdds, inSource->numBroadPhaseAdds, sizeof( NumBroadPhaseAdds ) );" ),
	CustomProperty( "PxSimulationStatistics",	"NumBroadPhaseRemoves",		"NumBroadPhaseRemovesProperty", "PxU32 NumBroadPhaseRemoves[PxSimulationStatistics::eVOLUME_COUNT];", "physx::shdfnd::memCopy( NumBroadPhaseRemoves, inSource->numBroadPhaseRemoves, sizeof( NumBroadPhaseRemoves ) );" ),
	CustomProperty( "PxSimulationStatistics",	"NumShapes",				"NumShapesProperty", "PxU32 NumShapes[PxGeometryType::eGEOMETRY_COUNT];", "physx::shdfnd::memCopy( NumShapes, inSource->numShapes, sizeof( NumShapes ) );" ),
...
#endif
#if PX_USE_CLOTH_API
	CustomProperty( "PxClothFabric",			"PhaseTypes",				"PhaseTypesProperty", "", "" ),
	CustomProperty( "PxCloth", 					"PhaseSolverConfig",		"PhaseSolverConfigProperty", "", "" ),
#endif
};
